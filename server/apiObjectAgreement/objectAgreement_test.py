...
class TestObjectAgreementRest(unittest.TestCase):
    def setUp(self):
        self.domain = 'mi.co'
    ...
    # create a new marca
    def test_getallObjectAgreement(self):
        path1 = 'apiFuec/allObjectAgreement'  # Only candidate role
...
suite = unittest.TestLoader().loadTestsFromTestCase(TestObjectAgreementRest)
